...
import br.com.imepac.especialidade.*;
 ...
 * @author lenovo
 */
@WebServlet(name = "EspecialidadeDelete", urlPatterns = {"/especialidade/EspecialidadeDelete"})
public class EspecialidadeDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (String idValue : request.getParameterValues("deleted")) {
                ...
                especialidadeDAO.delete(Integer.parseInt(idValue));
            }
