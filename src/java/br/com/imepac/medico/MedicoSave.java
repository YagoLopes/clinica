 ...
 * @author lenovo
 */
@WebServlet(name = "MedicoSave", urlPatterns = {"/medico/MedicoSave"})
public class MedicoSave extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (nome.isEmpty() == true) {//validação de campo obrigatorio
                ...
                request.getServletContext().getRequestDispatcher("/medico/cadastrar.jsp").forward(request, response);
            }
            if (crm.isEmpty() == true) {//validação de campo obrigatorio
                ...
                response.sendRedirect("/medico/cadastrar.jsp");
            }
